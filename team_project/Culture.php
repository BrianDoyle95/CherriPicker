...
<html class="nom-js" lang=""> 
    <head>
        ...
        <title>Cherri Picker - Culture</title>
                                        ...
                                        {  ?>
                                         ...
                                         <div class="single_portfolio tile scale-anm bcards photo">
                                          ...
                                          <div class="grid_item_overlay">
                                            ...
                                            <h3><?php echo $row['CultName'] ?></h3>
                                            <p><?php echo $row['CultLocation'] ?></p>
                                        
                                           <a href="CultureEvent.php?id=<?php echo $row['CultID'] ?>"><button type="button" class="btn btn-info btn-lg">Event Details</button></a>    
